...
//        array('name', 'checkName', '标识已经存在', self::VALUE_VALIDATE, 'callback', self::MODEL_BOTH),
        ...
        array('destination_p', '/^[0-9]{6}$/', '请选择目的地省份', self::EXISTS_VALIDATE, 'regex', self::MODEL_BOTH),
        array('destination_c', '/^[0-9]{6}$/', '请选择目的地城市', self::EXISTS_VALIDATE, 'regex', self::MODEL_BOTH),
        array('destination_a', '/^[0-9]{6}$/', '请选择目的地县区', self::EXISTS_VALIDATE, 'regex', self::MODEL_BOTH),
